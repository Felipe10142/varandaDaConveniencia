    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          <RotatingText
            texts={rotatingTexts}
            mainClassName="px-2 sm:px-2 md:px-3 bg-white/10 backdrop-blur-sm text-white overflow-hidden py-2 sm:py-3 md:py-4 justify-center rounded-lg text-xl sm:text-2xl md:text-3xl font-bold mx-auto w-fit block"
            staggerFrom="last"
            initial={{
              y: "100%",
            }}
