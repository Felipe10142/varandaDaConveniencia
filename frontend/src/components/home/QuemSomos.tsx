...
const QuemSomos: React.FC = () => {
  ...
  return <section id="quem-somos" ref={sectionRef} className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          {/* Image column */}
          <AnimatedContent direction="horizontal" reverse={true} duration={1} className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
            <div className="relative">
              <GlareHover width="100%" height="auto" background="transparent" borderRadius="0.5rem" glareColor="#D62828" glareOpacity={0.4} glareSize={200} className="rounded-lg overflow-hidden shadow-xl">
                <motion.img src="/image.png" alt="Família Varanda da Conveniência" className="w-full h-auto" whileHover={{
                scale: 1.05
              }} transition={{
                duration: 0.5
              }} />
              </GlareHover>
              <motion.div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-primary to-secondary text-white p-6 rounded-lg shadow-lg hidden md:block" initial={{
              opacity: 0,
              scale: 0.8
            }} animate={isInView ? {
              opacity: 1,
          ...
          {/* Text column */}
          <AnimatedContent direction="horizontal" duration={1} delay={0.3} className="md:w-1/2">
            ...
            <ScrollReveal enableBlur={true} baseOpacity={0.4} baseRotation={1} containerClassName="mb-6">
