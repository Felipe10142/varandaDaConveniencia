...
const TrueFocus: React.FC<TrueFocusProps> = ({
  ...
  return <div className="relative flex gap-4 justify-center items-center flex-wrap" ref={containerRef}>
      ...
      } as React.CSSProperties} onMouseEnter={() => handleMouseEnter(index)} onMouseLeave={handleMouseLeave}>
            {word}
          </span>;
    })}
