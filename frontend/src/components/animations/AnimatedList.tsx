...
const AnimatedList: React.FC<AnimatedListProps> = ({
  ...
  return (
    <div className={`relative w-full max-w-[500px] ${className}`}>
      <div
        ref={listRef}
        className={`max-h-[400px] overflow-y-auto p-4 [&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#060010] [&::-webkit-scrollbar-thumb]:bg-[#222] [&::-webkit-scrollbar-thumb]:rounded-[4px]`}
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`p-4 bg-[#111] rounded-lg ${selectedIndex === index ? "bg-[#222]" : ""}`}
            >
